...
import '../../styles/screens/citiesScreens/georgiaScreen.scss';
...
const GeorgiaScreen = () => {
  ...
  const breadcrumbList = [
    ...
    { link: '/cities/ga', label: 'Georgia', color: '#017aff' },
  ];
  return (
    <div className='georgiaScreen'>
      <CitiesLandingPage
        city='Georgia'
      ...
      <CitiesCustomerReviewContainer city='Georgia' />
    </div>
  );
};

export default GeorgiaScreen;
