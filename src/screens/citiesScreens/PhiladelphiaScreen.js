...
import '../../styles/screens/citiesScreens/philadelphiaScreen.scss';
...
const PhiladelphiaScreen = () => {
  ...
  const breadcrumbList = [
    ...
    { link: '/cities/pa', label: 'Pennsylvania', color: '#a1abb0' },
    { link: '/cities/pa/philadelphia', label: 'Philadelphia', color: '#017aff' },
  ];
  return (
    <div className='philadelphiaScreen'>
      <CitiesLandingPage city='Philadelphia' />
