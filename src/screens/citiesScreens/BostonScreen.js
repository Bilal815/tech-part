...
import '../../styles/screens/citiesScreens/bostonScreen.scss';
...
const BostonScreen = () => {
  ...
  const breadcrumbList = [
    ...
    { link: '/cities/ma', label: 'Massachusetts', color: '#a1abb0' },
    { link: '/cities/ma/boston', label: 'Boston', color: '#017aff' },
  ];
  return (
    <div className='bostonScreen'>
      <CitiesLandingPage city='Boston' />
      <CitiesBreadCrumb breadcrumbList={breadcrumbList} />
      <div className='container-70 container-y-25'>
        <CitiesMap
          mapImageRight
          city='Boston'
          imageUrl='https://s3.amazonaws.com/static.puls.com/website/SEO/Boston.jpg'
        />
      </div>
