...
const TopTechnicianNeighborhoodCardsSection = ({ screen }) => {
  const topTechnicianNeighborhoodCardInfo = [
    ...
    },
    {
      ...
      job: `Phone repair`,
      title: `A real MVP`,
      introduction: `I'm impressed at the efficiency of this company. If it were truly an emergency, TechNPart would be a real lifesaver. ... Sam was a real MVP, super professional and friendly and fixed me up in no time.`,
    ...
    },
    {
      ...
      job: `TV Mounting`,
      title: `1 hour & happy!`,
      introduction: `I struggled with fixing a wall mount until I Googled 'Houston TV mounting' and booked TechNPart. Robert showed up at 3 and was done by 4. Very courteous and fast. Highly recommended`,
  ...
  const topTechnicianNeighborhoodCardInfoBusiness = [
    ...
    },
    {
      ...
      introduction: `I dropped my iPhone yesterday going to lunch at my new job (can't take off so soon to handle something like this) so I found TechNPart. They took 10 minutes to fix my phone! I could have [traveled] across town and waited an hour - no thanks.`,
