...
const ServicesDropDown = (props) => {
    ...
    if (props.show && props.show === true) {
        return (
            <div className="shadow drp w-25">
                <ListGroup>
                    <ListGroup.Item className="link clickable p-3 p-3" onClick={() => { navigate("/services/tv-mounting") }} onMouseOver={() => { setTvMountingSrc(tvMountingHover) }} onMouseOut={() => { setTvMountingSrc(tvMounting) }}>
                        <span><img src={tvMountingSrc} width="45" className="icon"></img></span>
                        <span >
                            Tv Mounting
                      </span>
                    </ListGroup.Item>
                    <ListGroup.Item className="link clickable p-3" onClick={() => { navigate("/services/home-appliances") }} onMouseOver={() => { setHomeAppliancesSrc(homeAppliancesHover) }} onMouseOut={() => { setHomeAppliancesSrc(homeAppliances) }}>
                        <span >
                    ...
                    <ListGroup.Item className="link clickable p-3" onClick={() => { navigate("/services/disinfection") }} onMouseOver={() => { setDisinfectionSrc(disinfectionHover) }} onMouseOut={() => { setDisinfectionSrc(disinfection) }}>
                        <span >
                    ...
                    <ListGroup.Item className="link clickable p-3" onClick={() => { navigate("/services/garage-door-repair") }} onMouseOver={() => { setGarageDoorsSrc(garageDoorsHover) }} onMouseOut={() => { setGarageDoorsSrc(garageDoors) }}>
                        <span >
                    ...
                    <ListGroup.Item className="link clickable p-3" onClick={() => { navigate("/services/handyman") }} onMouseOver={() => { setHandymanServicesSrc(handymanServicesHover) }} onMouseOut={() => { setHandymanServicesSrc(handymanServices) }}>
                        <span >
                    ...
                    <ListGroup.Item className="link clickable p-3" onClick={() => { navigate("/services/iphone-repair") }} onMouseOver={() => { setPhoneSrc(phoneHover) }} onMouseOut={() => { setPhoneSrc(phone) }}>
                        <span >
                    ...
                    <ListGroup.Item className="link clickable p-3" onClick={() => { navigate("/services/plumbing") }} onMouseOver={() => { setPlumbingSrc(plumbingHover) }} onMouseOut={() => { setPlumbingSrc(plumbing) }}>
                        <span >
                    ...
                    <ListGroup.Item className="link clickable p-3" onClick={() => { navigate("/services/smart-home-installation") }} onMouseOver={() => { setSmartHomeSrc(smartHomeHover) }} onMouseOut={() => { setSmartHomeSrc(smartHome) }}>
                        <span >
